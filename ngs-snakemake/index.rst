...
The second thing we have done is to assign the list of these ``{sample}`` variables to a list ofall variables. This is the ``STRAIN`` name, and we have performed (well...I have suggested) capitalisation because it is a list of all important variables.
