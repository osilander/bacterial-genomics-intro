...
copyright = u'2016-2021, Sebastian Schmeier (https://sschmeier.com) and Olin Silander (https://www.silanderlab.com)'
...
latex_documents = [
    (master_doc, 'Genomics.tex', u'Introduction to Genomics Tutorial',
     u'Olin Silander (https://silanderlab.com)', 'manual'),
]
